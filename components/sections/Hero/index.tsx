        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in">
            <div className="phone-mockup">
              <div className="phone-screen w-[280px] h-[560px] relative">
                <Image
                  src="/sample.jpg"
                  alt="WinkyPie App Preview"
                  fill
            ...
            <div className="absolute -bottom-4 -left-4 lg:left-auto lg:-right-4 bg-card p-4 rounded-2xl border border-border shadow-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">Instant results</p>
                </div>
              </div>
            </div>
          </div>
